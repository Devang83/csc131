<%@ Page Language="C#" MasterPageFile="~/BaseMaster.master" AutoEventWireup="true" Inherits="Reports_CashReceipts" Title="Untitled Page" Codebehind="CashReceipts.aspx.cs" %>
...
<div id="content">
    <% if (Session["CashReceiptsReportHtml"] == null)
       { %>
    <table>
    <tr><th>Cash Receipts Report</th></tr>
    <tr>
        <td align="right"><asp:Label ID="Label1" runat="server" Text="Property:"></asp:Label></td>
        <td align="left">
    ...
    <% if (Session["CashReceiptsReportHtml"] != null)           
           {
               Session["CashReceiptsReportHtmlPrint"] = Session["CashReceiptsReportHtml"];               
           %>
            <a href="<%= ResolveUrl("~/Reports/Print.aspx?" + GenerateParams()) %>">Print Friendly</a>
           <br />
           <%= Session["CashReceiptsReportHtml"]%>
           
           <% Session["CashReceiptsReportHtml"] = null;
           } %>
           </div>    
</asp:Content>
