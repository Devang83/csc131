...
namespace Mascix.SqliteProviders
{
    public sealed class SqliteProfileProvider : ProfileProvider
    {
        ...
        public override ProfileInfoCollection GetAllProfiles(ProfileAuthenticationOption authenticationOption, int pageIndex, int pageSize, out int totalRecords)
        {
            ...
            holder.Open();
            int appId = GetApplicationId(holder);
            string sqlQuery = "SELECT users.UserName, users.LastActivityDate, aspnet_Profile.LastUpdatedDate, LENGTH(aspnet_Profile.PropertyNames) + LENGTH(aspnet_Profile.PropertyValuesString) FROM users, aspnet_Profile WHERE " + "users.PKID = aspnet_Profile.PKID ";
